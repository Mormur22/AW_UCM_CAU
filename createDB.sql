...
INSERT INTO UCM_AW_CAU_USU_Usuarios (idUsu, email, password, nombre, perfil, imagen, desactivado, reputacion) VALUES
  ...
  ( 2, 'ctorres@ucm.es', 'letmein', 'Carlota Torres', 'alumno', 'ctorres.jpg', 0, 50.00 ),
  ( 3, 'msalas@ucm.es', 'letmein', 'Matias Salas', 'alumno', 'msalas.jpg', 0, 50.00 ),
  ( 4, 'nroca@ucm.es', 'letmein', 'Nuria Roca', 'alumno', 'nroca.jpg', 0, 50.00 ),
  ( 5, 'rcontreras@ucm.es', 'letmein', 'Ruben Contreras', 'alumno', 'rcontreras.jpg', 0, 50.00 ),
  ( 6, 'vramos@ucm.es', 'letmein', 'Vanesa Ramos', 'alumno', 'vramos.jpg', 0, 50.00 ),
  ( 7, 'vramirez@ucm.es', 'letmein', 'Victor Ramirez', 'alumno', 'vramirez.jpg', 0, 50.00 ),
  ( 8, 'bgerpe@ucm.es', 'letmein', 'Begoña Gerpe', 'pdi', 'bgerpe.jpg', 0, 50.00 ),
  ( 9, 'eporto@ucm.es', 'letmein', 'Eva Porto', 'pdi', 'eporto.jpg', 0, 50.00 ),
  ( 10, 'jsantaolalla@ucm.es', 'letmein', 'Javier Santaolalla', 'pdi', 'jsantaolalla.jpg', 0, 50.00 ),
  ( 11, 'maranda@ucm.es', 'letmein', 'Marcos Aranda', 'pdi', 'maranda.jpg', 0, 50.00 ),
  ( 12, 'rguzman@ucm.es', 'letmein', 'Roberto Guzman', 'pdi', 'rguzman.jpg', 0, 50.00 ),
  ( 13, 'smontes@ucm.es', 'letmein', 'Sabrina Montes', 'pdi', 'smontes.jpg', 0, 50.00 ),
  ( 14, 'agarrido@ucm.es', 'letmein', 'Ana Garrido', 'pas', 'agarrido.jpg', 0, 50.00 ),
  ( 15, 'csamper@ucm.es', 'letmein', 'Cristian Samper', 'pas', 'csamper.jpg', 0, 50.00 ),
  ( 16, 'mhall@ucm.es', 'letmein', 'Meredith Hall', 'pas', 'mhall.jpg', 0, 50.00 ),
  ( 17, 'rsantos@ucm.es', 'letmein', 'Rebeca Santos', 'pas', 'rsantos.jpg', 0, 50.00 ),
  ( 18, 'tbrown@ucm.es', 'letmein', 'Taylor Brown', 'pas', 'tbrown.jpg', 0, 50.00 ),
  ( 19, 'jmolina@ucm.es', 'letmein', 'Julian Molina', 'aa', 'jmolina.jpg', 0, 50.00 ),
  ( 20, 'tmorgan@ucm.es', 'letmein', 'Tina Morgan', 'aa', 'tmorgan.jpg', 0, 50.00 );
