...
INSERT INTO UCM_AW_CAU_AVI_Avisos (idAvi, tipo, categoria, subcategoria, fecha, observaciones, comentario, cerrado, cancelado, idUsu, idTec) VALUES
  ...
  ( 25, 'incidencia', 'comunicaciones', 'correo_electronico', '2023-02-08', 'Mi correo de la UCM no recibe mensajes.', 'Hemos resuelto un problema con el servidor de correo. Deberías recibir correos normalmente ahora.', 1, 0, 1, NULL),
  ( 26, 'sugerencia', 'docencia', 'aula_virtual', '2023-02-09', 'Sería útil tener un calendario de eventos en el aula virtual.', 'Gracias por tu sugerencia. La pasaremos al equipo encargado.', 1, 0, 2, NULL),
  ( 27, 'incidencia', 'comunicaciones', 'correo_electronico', '2023-02-10', 'No puedo cambiar la contraseña de mi correo de la UCM.', 'Se ha solucionado el problema con la función de cambio de contraseña.', 1, 0, 3, NULL),
  ( 28, 'felicitacion', 'informatica', NULL, '2023-02-13', 'El servicio de atención al cliente es excepcional. ¡Gran trabajo!', 'Agradecemos tus comentarios positivos. ¡Nuestro objetivo es proporcionar el mejor servicio posible!', 1, 0, 4, NULL),
  ( 29, 'incidencia', 'comunicaciones', 'correo_electronico', '2023-02-14', 'No estoy recibiendo correos en mi cuenta de la UCM.', 'Estamos investigando el problema, por favor, ten paciencia.', 1, 0, 1, NULL),
  ( 30, 'incidencia', 'docencia', 'aula_virtual', '2023-02-15', 'No puedo subir archivos al aula virtual.', 'Hemos resuelto el problema, ya deberías poder subir archivos.', 1, 0, 2, NULL),
  ( 31, 'incidencia', 'comunicaciones', 'correo_electronico', '2023-02-16', 'Mi correo de la UCM parece haber sido hackeado.', 'Por seguridad, hemos bloqueado tu cuenta mientras investigamos.', 1, 0, 3, NULL),
  ( 32, 'incidencia', 'informatica', 'hardware', '2023-02-17', 'Mi portátil de la UCM no se enciende.', 'Este aviso ha sido cancelado por el técnico Pablo Juarez debido a: \n\nEl usuario resolvió el problema por su cuenta.', 0, 1, 4, NULL),
  ( 33, 'sugerencia', 'docencia', 'aula_virtual', '2023-02-20', 'Sería útil poder ver las calificaciones en el aula virtual.', 'Estamos considerando la implementación de esta funcionalidad. Gracias por tu sugerencia.', 1, 0, 5, NULL),
  ( 34, 'felicitacion', 'informatica', NULL, '2023-02-21', 'La nueva actualización del sistema es increíble, ¡gracias!', 'Agradecemos tus comentarios positivos. ¡Trabajamos duro para mejorar nuestros servicios!', 1, 0, 1, NULL),
  ( 35, 'incidencia', 'comunicaciones', 'correo_electronico', '2023-02-22', 'Todos los correos que envío desde mi cuenta de la UCM están yendo a la carpeta de spam.', 'Estamos trabajando en este problema, agradecemos tu paciencia.', 1, 0, 3, NULL),
  ( 36, 'sugerencia', 'docencia', 'aula_virtual', '2023-02-23', 'El aula virtual podría tener un diseño más atractivo.', 'Gracias por tu sugerencia, se la haremos llegar al equipo de diseño.', 1, 0, 2, NULL),
  ...
  ( 38, 'felicitacion', 'informatica', NULL, '2023-02-27', 'Sois unos maquinas', '¡Gracias por el cunmplido!. Intentamos hacerlo lo mejor posible.', 1, 0, 4, NULL),
  ( 39, 'incidencia', 'comunicaciones', 'correo_electronico', '2023-02-28', 'No puedo enviar correos desde mi cuenta de UCM.', 'Se ha revisado y corregido el problema con el servidor de correo.', 1, 0, 3, NULL);
  ( 40, 'sugerencia', 'administracion', 'certificado_digital', '2023-05-22', '¡Una brisa misteriosa solicita el certificado digital!', NULL, 0, 0, 1, NULL),
  ( 41, 'sugerencia', 'comunicaciones', 'google_meet', '2023-05-21', 'El canto del encuentro virtual se desvanece en el éter', NULL, 0, 0, 2, NULL),
  ( 42, 'sugerencia', 'conectividad', 'wifi_eduroam', '2023-05-20', 'Entre las ondas se pierde la conexión, en busca de Eduroam', NULL, 0, 0, 3, NULL),
  ( 43, 'sugerencia', 'docencia', 'blackboard_collaborate', '2023-05-19', 'En el aula virtual, susurros de colaboración se desvanecen', NULL, 0, 0, 4, NULL),
  ( 44, 'sugerencia', 'web', 'portal_eventos', '2023-05-18', 'El portal de eventos en sombras y misterio se sumerge', NULL, 0, 0, 5, NULL),
  ( 45, 'sugerencia', 'administracion', 'certificado_electronico', '2023-05-17', 'En el archivo perdido, un eco de certificados electrónicos', NULL, 0, 0, 6, NULL),
  ( 46, 'sugerencia', 'administracion', 'portafirmas', '2023-05-16', 'La firma espera en el umbral del portafirmas', NULL, 0, 0, 7, NULL),
  ( 47, 'sugerencia', 'administracion', 'registro_electronico', '2023-05-15', 'En el rincón de la biblioteca, un susurro de registro electrónico', NULL, 0, 0, 8, NULL),
  ( 48, 'sugerencia', 'administracion', 'sede_electronica', '2023-05-14', 'En el centro de información, un portal hacia la sede electrónica', NULL, 0, 0, 9, NULL),
  ( 49, 'sugerencia', 'administracion', 'certificado_digital', '2023-05-13', 'En los departamentos docentes, un eco de certificados digitales', NULL, 0, 0, 10, NULL),
  ...
  ( 52, 'incidencia', 'docencia', 'aula_virtual', '2023-05-10', 'En el aula virtual, un eco de preguntas sin respuesta', 'La sabiduría se alza, la incidencia se disipa en la enseñanza', 0, 1, 13, 3),
  ...
  ( 56, 'incidencia', 'docencia', 'moodle', '2023-05-06', 'En la plataforma virtual, un eco de preguntas sin respuesta', 'La sabiduría se alza, la incidencia se disipa en la enseñanza', 0, 1, 17, 3),
  ...
  ( 58, 'incidencia', 'administracion', 'certificado_electronico', '2023-05-04', 'En el laberinto de certificados, uno se extravía', '¡El certificado resurge, la senda de la electrónica ilumina!', 0, 1, 19, 1),
