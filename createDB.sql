...
INSERT INTO UCM_AW_CAU_AVI_Avisos ( idAvi, tipo, categoria, subcategoria, fecha, observaciones, comentario, cerrado, cancelado, idUsu, idTec ) VALUES
  ...
  ( 13, 'sugerencia', 'informatica', 'software', '2023-01-20', 'El software de la biblioteca podría ser más intuitivo.', 'Se ha enviado la sugerencia al equipo de desarrollo.', 1, 0, 17, 2),  -- csamper (pas) / csolis [MAL]
  ...
  ( 25, 'incidencia', 'docencia', 'aula_virtual', '2023-02-07', 'No puedo ver las tareas para mi clase de física.', 'Se ha actualizado la lista de tareas en el aula virtual.', 1, 0, NULL, 4), -- [REPETIDA]
  ( 26, 'incidencia', 'comunicaciones', 'correo_electronico', '2023-02-08', 'Mi correo de la UCM no recibe mensajes.', 'Hemos resuelto un problema con el servidor de correo. Deberías recibir correos normalmente ahora.', 1, 0, NULL, 1),
  ( 27, 'sugerencia', 'docencia', 'aula_virtual', '2023-02-09', 'Sería útil tener un calendario de eventos en el aula virtual.', 'Gracias por tu sugerencia. La pasaremos al equipo encargado.', 1, 0, NULL, 2),
  ( 28, 'incidencia', 'comunicaciones', 'correo_electronico', '2023-02-10', 'No puedo cambiar la contraseña de mi correo de la UCM.', 'Se ha solucionado el problema con la función de cambio de contraseña.', 1, 0, NULL, 3),
  ( 29, 'felicitacion', 'informatica', NULL, '2023-02-13', 'El servicio de atención al cliente es excepcional. ¡Gran trabajo!', 'Agradecemos tus comentarios positivos. ¡Nuestro objetivo es proporcionar el mejor servicio posible!', 1, 0, NULL, 4),
  ( 30, 'incidencia', 'comunicaciones', 'correo_electronico', '2023-02-14', 'No estoy recibiendo correos en mi cuenta de la UCM.', 'Estamos investigando el problema, por favor, ten paciencia.', 1, 0, NULL, 1),
  ( 31, 'incidencia', 'docencia', 'aula_virtual', '2023-02-15', 'No puedo subir archivos al aula virtual.', 'Hemos resuelto el problema, ya deberías poder subir archivos.', 1, 0, NULL, 2),
  ( 32, 'incidencia', 'comunicaciones', 'correo_electronico', '2023-02-16', 'Mi correo de la UCM parece haber sido hackeado.', 'Por seguridad, hemos bloqueado tu cuenta mientras investigamos.', 1, 0, NULL, 3),
  ...
  ( 34, 'sugerencia', 'docencia', 'aula_virtual', '2023-02-20', 'Sería útil poder ver las calificaciones en el aula virtual.', 'Estamos considerando la implementación de esta funcionalidad. Gracias por tu sugerencia.', 1, 0, NULL, 5),
  ( 35, 'felicitacion', 'informatica', NULL, '2023-02-21', 'La nueva actualización del sistema es increíble, ¡gracias!', 'Agradecemos tus comentarios positivos. ¡Trabajamos duro para mejorar nuestros servicios!', 1, 0, NULL, 1),
  ( 36, 'incidencia', 'comunicaciones', 'correo_electronico', '2023-02-22', 'Todos los correos que envío desde mi cuenta de la UCM están yendo a la carpeta de spam.', 'Estamos trabajando en este problema, agradecemos tu paciencia.', 1, 0, NULL, 3),
  ( 37, 'sugerencia', 'docencia', 'aula_virtual', '2023-02-23', 'El aula virtual podría tener un diseño más atractivo.', 'Gracias por tu sugerencia, se la haremos llegar al equipo de diseño.', 1, 0, NULL, 2),
  ...
  ( 39, 'felicitacion', 'informatica', NULL, '2023-02-27', 'El servicio de atención al cliente es excepcional. ¡Gran trabajo!', 'Agradecemos tus comentarios positivos. ¡Nuestro objetivo es proporcionar el mejor servicio posible!', 1, 0, NULL, 4),  -- [REPETIDA]
  ( 40, 'incidencia', 'comunicaciones', 'correo_electronico', '2023-02-28', 'No puedo enviar correos desde mi cuenta de UCM.', 'Se ha revisado y corregido el problema con el servidor de correo.', 1, 0, NULL, 3);